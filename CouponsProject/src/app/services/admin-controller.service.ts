...
export class AdminControllerService {
  ...
  public updateCustomer(token: String, customer:Customer){
    return this.httpClient.post("http://localhost:8080/admin/update/customer/" + token, customer)
  }
  public updateCompany(token: String, company:Company){
    return this.httpClient.post("http://localhost:8080/admin/update/company/" + token, company)
  }
